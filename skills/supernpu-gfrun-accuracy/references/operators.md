...
| RmsNorm | PR #84, https://github.com/PTO-ISA/SuperNPUBench/pull/84 | Both `benchmark/one-level-arch/test/kernel/normalization/rms_norm` and `rms_norm_binary`; validate only dynamic-shape 4PE variants from each `compile.all` |
